...
model_path = {
    'uniformer_small_k400_16x4': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 center no aug/best_checkpoints_loss.pth'),
    
    'UFOneView_MultiVSL200_center': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 center mixup alpha 0.8/best_checkpoints_loss.pth'),
    'UFOneView_MultiVSL200_left': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 left mixup alpha 0.8/best_checkpoints_loss.pth'),
    'UFOneView_MultiVSL200_right': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 right mixup alpha 0.8/best_checkpoints_loss.pth'),
    
    'MaskUFOneView_MultiVSL200_center': os.path.join(model_path, 'MaskUFOneView/MaskUFOneView MultiVLS200 center mask ratio 0.4/checkpoint_epoch_300.pth'),
    'MaskUFOneView_MultiVSL200_left': os.path.join(model_path, 'MaskUFOneView/MaskUFOneView MultiVLS200 left mask ratio 0.4/checkpoint_epoch_300.pth'),
    'MaskUFOneView_MultiVSL200_right': os.path.join(model_path, 'MaskUFOneView/MaskUFOneView MultiVLS200 right mask ratio 0.4/checkpoint_epoch_300.pth'),
    ...
    'FromMask_MultiVSL200_center': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaskUFOneView MultiVLS200 center mixup alpha 0.8/best_checkpoints_loss.pth'),
    'FromMask_MultiVSL200_left': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaskUFOneView MultiVLS200 left mixup alpha 0.8/best_checkpoints_loss.pth'),
    'FromMask_MultiVSL200_right': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaskUFOneView MultiVLS200 right mixup alpha 0.8/best_checkpoints_loss.pth'),
    
    'FromMaxFlowMask_MultiVSL200_center': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaxFlow MaskUFOneView MultiVLS200 center mixup alpha 0.8/best_checkpoints_loss.pth'),
    'FromMaxFlowMask_MultiVSL200_left': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaxFlow MaskUFOneView MultiVLS200 left mixup alpha 0.8/best_checkpoints_loss.pth'),
    'FromMaxFlowMask_MultiVSL200_right': os.path.join(model_path, 'UFOneView/UFOneView MultiVLS200 from MaxFlow MaskUFOneView MultiVLS200 right mixup alpha 0.8/best_checkpoints_loss.pth'),
}
...
class Uniformer(nn.Module):
    ...
    #                 # Nếu key liên quan đến head và model mới không có head (ví dụ, head là Identity), xóa key đó
    #                 if k.startswith("head."):
    #                     del checkpoint[k]
    #                 continue
    #             if v.shape != state_dict_3d[k].shape:
    #                 if len(state_dict_3d[k].shape) <= 2:
    #                     continue
    #                 time_dim = state_dict_3d[k].shape[2]
    #                 checkpoint[k] = self.inflate_weight(v, time_dim)
